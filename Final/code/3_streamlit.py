...
TABLE_CSV = Path("Final/outputs/table1.csv")

AIM1_FIGURES = [
    Path("Final/outputs/aim1_total_alcohol_by_sex.png"),
    Path("Final/outputs/aim1_total_alcohol_by_school.png"),]

AIM2_FIGURES = [
    Path("Final/outputs/aim2_FinalGrade_histogram.png"),
    Path("Final/outputs/aim2_FinalGrade_vs_age.png"),
    Path("Final/outputs/aim2_FinalGrade_vs_absences.png"),
    Path("Final/outputs/aim2_FinalGrade_by_studytime.png"),
    Path("Final/outputs/aim2_FinalGrade_by_goout.png"),
    Path("Final/outputs/aim2_FinalGrade_by_Medu.png"),
    Path("Final/outputs/aim2_FinalGrade_by_Fedu.png"),
    Path("Final/outputs/aim2_FinalGrade_by_sex.png"),
    Path("Final/outputs/aim2_FinalGrade_by_school.png"),
    Path("Final/outputs/aim2_FinalGrade_by_any_parent_teacher.png"),]
...
st.download_button(label="Download Table 1 CSV", data=TABLE_CSV.read_bytes(), file_name="table1.csv", mime="text/csv",)
...
with col_aim1:
    st.markdown("### Aim 1")
    selected_aim1 = st.selectbox("Select Aim 1 plot", options=list(aim1_options.keys()), key="aim1_plot_select",)
    st.image(str(aim1_options[selected_aim1]), caption=selected_aim1, use_container_width=True,)

with col_aim2:
    st.markdown("### Aim 2")
    selected_aim2 = st.selectbox("Select Aim 2 plot", options=list(aim2_options.keys()), key="aim2_plot_select",)
